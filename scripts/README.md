...
| [test-upstream-connectivity.sh](test-upstream-connectivity.sh) | Wi-Fi security classification |
| [test-upstream-tray.sh](test-upstream-tray.sh) | Confirmation-control availability transitions |
