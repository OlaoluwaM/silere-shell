...
This copy is checked into `.agents/skills/qt-qml-review/` for Silere Shell.
Codex discovers it within this repository; `AGENTS.md` points other agents
to the same local workflow. Preserve its references and license when updating.

The following are upstream installation options for other environments.
