...
Item {
    ...
    Component { id: _cShellUpdate; ShellUpdateWidget { anchors.verticalCenter: parent.verticalCenter; height: root.height; screen: root.screen; hintScreen: root.screen; compact: root.effectiveCompact; barActive: root.barActive } }
    ...
    Component { id: _cUpdates;     UpdatesWidget    { anchors.verticalCenter: parent.verticalCenter; height: root.height; screen: root.screen; hintScreen: root.screen; compact: root.effectiveCompact; barActive: root.barActive } }
