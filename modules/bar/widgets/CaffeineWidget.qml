...
// StatusActionPill, not the plain Pill BatteryWidget/BluetoothWidget use — those two
// are display-only, but this pill is also the fastest way to flip the manual unit off,
// so it needs the click wiring StatusActionPill already gives UpdatesWidget. `show`
